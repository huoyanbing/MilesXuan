...
csc /t:library /out:D:\HansLinkSoftware\HansLinkManage\HansLinkManage\bin\Debug\CommonClass.dll F:\system\HansLinkManage\HansLinkManage\CommonClass\FileOperate.cs F:\system\HansLinkManage\HansLinkManage\CommonClass\LogHelper.cs F:\system\HansLinkManage\HansLinkManage\CommonClass\NamedPipe.cs F:\system\HansLinkManage\HansLinkManage\CommonClass\SerialPortComm.cs
@goto end
