...
csc /t:library /out:D:\HansLinkSoftware\HansLinkManage\HansLinkManage\bin\Debug\CommonClass.dll G:\system\HansLinkManage\HansLinkManage\CommonClass\FileOperate.cs G:\system\HansLinkManage\HansLinkManage\CommonClass\LogHelper.cs G:\system\HansLinkManage\HansLinkManage\CommonClass\NamedPipe.cs G:\system\HansLinkManage\HansLinkManage\CommonClass\SerialPortComm.cs
@goto end
